...
AWS_S3_CUSTOM_DOMAIN = f"{env('DJANGO_AWS_STORAGE_BUCKET_NAME')}.{env('DJANGO_AWS_S3_CUSTOM_DOMAIN')}"
...
OPENSEARCH_DSL = {
    "default": {
        ...
        "timeout": 30,
        "http_compress": True,
        "url_prefix": env("OPENSEARCH_URL_PREFIX", default=""),
    },
}
