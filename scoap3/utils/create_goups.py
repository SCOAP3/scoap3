...
def create_custom_groups():
    ...
    view_permission = Permission.objects.get(codename='view_article', content_type=article_content_type)
    ...
    api_user_group.permissions.add(view_permission)
    advanced_user_group.permissions.add(view_permission, add_permission)
